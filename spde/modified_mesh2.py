...
corrLength = 145.5
nu = 3  # only integer values will be used
variance = 20.
...
for i in range(1, nuInt):

    b = fncs.Vector(sol.vector())

    solver.solve(sol.vector(), b)


solEvaluation = sol.compute_vertex_values(mesh)
